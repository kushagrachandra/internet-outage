...
from outage_monitor.config import load_mysql_config
...
def _utc_naive() -> datetime:
    """UTC wall time as naive datetime for MySQL DATETIME columns."""
...
def main() -> None:
    ...
    conn = connect(cfg)
    close_open_outages_at_restart(conn, ended_at=_utc_naive())
